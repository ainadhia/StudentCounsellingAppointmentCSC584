...
<head>
   ...
   <style>
    ...
    /* --- 3. FIXED MODAL STYLES (Alignment Fixed) --- */
    ...
    /* Main Modal Container - The Single Card */
    .status-modal {
        background: white;
        border-radius: 16px;
        width: 100%;
        max-width: 500px; /* Fixed max width */
        margin: 0 20px;   /* Margin for mobile screens */
    ...
    /* Header: Flush with top, full width */
    .modal-header {
        width: 100%;
    ...
    .notes-content {
        ...
        padding: 15px;
        border-radius: 4px; /* Slightly squared for cleaner look */
        color: #444;
        font-size: 0.95rem;
        line-height: 1.5;
        min-height: 60px;
...
<script>
    function openView(dateText, timeText, counselor, status, notes) {
        ...
        // Handle Status Pill Styling in Modal
