...
public class AppointmentServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        appointmentDAO = new AppointmentDAO(DBConnection.createConnection());
    }
        ...
        try {
            switch (action) {
                ...
                case "getAvailableSessions":
                    getAvailableSessionsAjax(request, response);
                    break;
                case "complete":
    ...
    private void rescheduleAppointment(HttpServletRequest request, HttpSession httpSession, 
        ...
        apt.setAppointmentStatus("Pending");
        ...
        boolean sessionUpdated = sessionDAO.updateSessionStatus(newSessionID, "unavailable");
    ...
    private void listAppointments(HttpServletRequest request, HttpServletResponse response, int counselorID) 
        ...
        for (Appointment apt : appointments) {
            ...
            if (apt.getSessionID() > 0) {
                try {
                    Session sessionObj = sessionDAO.getSessionById(apt.getSessionID());
                    if (sessionObj != null) {
